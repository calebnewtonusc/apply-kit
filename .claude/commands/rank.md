...
**Strong, next five.** Same format, one line each.

**The solid middle.** A list, no commentary. Naming them is enough.
...
Name **the one answer to spend ten minutes on tonight**, and say why that one rather
than the others. Usually it is the answer where the material is genuinely still
missing, not the one that is merely weakest, because missing material is the only
thing they cannot fix by rereading it.

If an answer is weak because you wrote around a gap instead of asking, say that
plainly. That one is yours to flag, not theirs to discover.
