...
yourself only that answer, nothing else, and ask whether a reader could answer each
unasked question from it alone. Report per answer:

- Which unasked questions it answers
- Which it misses
- Whether the fix is a different story or a different sentence

Three misses on one answer is a revision, and it is usually a swap of story rather
than a rewrite of sentences.
...
applicant: this is what you are actually being evaluated on this fall, under all the
different wording.
